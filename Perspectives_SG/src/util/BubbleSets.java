...
public class BubbleSets {
	...
	Rectangle2D.Double[] points = null;
	
	Rectangle[] pointsD = null; //discrete points - on the grid
	...
	public ArrayList< ArrayList<Point2D.Double>> paths;
	
	public Point2D.Double centroid = null;
	
	public int[] sortedS = null;
	...
	public double[][] computeContour(double cellSize, int R1, int R0, int set)
	{
		...
		//pointsD now creates int rectangles on the grid
			...
			System.out.println("comp cont done");
